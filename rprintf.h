...
// u04,uint8_t,uint16_t,and uint32_t functions handle 4,8,16,or 32 bits respectively
void rprintfu04(unsigned char data);	///< Print 4-bit hex number. Outputs a single hex character.
void rprintfuint8_t(unsigned char data);	///< Print 8-bit hex number. Outputs two hex characters.
