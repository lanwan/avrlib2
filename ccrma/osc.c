...
extern volatile uint8_t uartReadyTx;
...
void oscSendMessageInt(char *address, uint32_t arg)
{
...
void oscSendMessageIntInt(char *address, uint32_t arg1, uint32_t arg2)
{
...
void oscWriteHeader(char *address, uint8_t arglen)
{
	uint8_t len;
