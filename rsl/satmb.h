...
//  TRUE = on
//  FALSE = off
void satmbSetSerialPortPower(uint8_t on);
...
void satmbV1SetPowerState(DallasSubsysId* targetSubsysId, uint8_t state);
...
void satmbV2SetPowerState(DallasSubsysId* targetSubsysId, uint8_t state);
