...
uint8_t EdpCommandResponseCode;
//uint8_t EdpCommandReplyLength;
uint8_t EdpCommandReplyBuffer[EDP_REPLY_BUFFER_SIZE];
uint8_t EdpCommandReplyChecksum;
// EDP slave: response code and reply buffer
uint8_t EdpSlaveResponseCode;
uint8_t EdpSlaveReplyLength;
uint8_t EdpSlaveReplyBuffer[EDP_REPLY_BUFFER_SIZE];
...
{
	uint8_t* replyData = EdpCommandReplyBuffer;
	uint8_t replyLength;
	uint8_t checksum;
