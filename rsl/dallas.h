...
uint8_t  dallasWriteRAM(dallas_rom_id_T* rom_id, uint16_t address, uint8_t len, uint8_t* data);
...
uint8_t  dallasFindDevices(dallas_rom_id_T rom_id[]);
