...
// Functions
uint8_t lis3l02Init(void)
{
	// reset LIS3L02 chip
	return lis3l02Reset();
}

uint8_t lis3l02Reset(void)
{
...
uint8_t lis3l02ReadReg(uint8_t reg)
{
	uint8_t data;
	uint8_t i2cStat;
...
uint8_t lis3l02WriteReg(uint8_t reg, uint8_t data)
{
	uint8_t packet[2];
	uint8_t i2cStat;
...
int16_t lis3l02GetAccel(uint8_t chxyz)
{
	int16_t value;
