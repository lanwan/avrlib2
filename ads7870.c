...
int16_t ads7870Convert(uint8_t channel)
{
...
int16_t ads7870ConvertDiff(uint8_t channel)
{
...
int16_t ads7870ConvertRaw(uint8_t channel)
{
	int16_t result;
	// assert chip select
...
uint8_t ads7870ReadReg(uint8_t reg)
{
	uint8_t data;
	// assert chip select
	cbi(ADS7870_CS_PORT, ADS7870_CS_PIN);
...
void ads7870WriteReg(uint8_t reg, uint8_t value)
{
	// assert chip select
	cbi(ADS7870_CS_PORT, ADS7870_CS_PIN);
