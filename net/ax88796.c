...
#if NIC_CONNECTION == MEMORY_MAPPED
inline void ax88796Write(uint8_t address, uint8_t data)
{
	*(volatile uint8_t*)(AX88796_MEMORY_MAPPED_OFFSET + address) = data;
}
#else
void ax88796Write(uint8_t address, uint8_t data)
{
	// assert the address
...
{
	return *(volatile uint8_t*)(AX88796_MEMORY_MAPPED_OFFSET + address);
}
#else
uint8_t ax88796Read(uint8_t address)
{
	uint8_t data;
