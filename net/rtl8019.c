...
#if NIC_CONNECTION == MEMORY_MAPPED
inline void rtl8019Write(uint8_t address, uint8_t data)
{
	*(volatile uint8_t*)(RTL8019_MEMORY_MAPPED_OFFSET + address) = data;
}
#else
...
#if NIC_CONNECTION == MEMORY_MAPPED
inline uint8_t ax88796Read(uint8_t address)
{
	return *(volatile uint8_t*)(RTL8019_MEMORY_MAPPED_OFFSET + address);
}
#else
...
//		rprintf("100BASE-T      \r\n");
	...
	rprintfProgStrM("       ");
	rprintfuint8_t(rtl8019Read(CR));
	rprintfProgStrM("  ");
	rprintfuint8_t(rtl8019Read(BNRY));
	rprintfProgStrM("   ");
	rprintfuint8_t(rtl8019Read(PSTART));
	rprintfProgStrM("  ");
	rprintfuint8_t(rtl8019Read(PSTOP));
	rprintfProgStrM("  ");
	rprintfuint8_t(rtl8019Read(ISR));
	rprintfProgStrM("  ");
	rprintfuint8_t(rtl8019Read(TSR));
	rprintfProgStrM("  ");
	rprintfuint8_t(rtl8019Read(RSR));
	rprintfProgStrM("  ");
//	rprintfuint8_t(rtl8019Read(MEMR));
	rprintfProgStrM("  ");
//	rprintfuint8_t(rtl8019Read(TR));
	rprintfProgStrM("  ");
//	rprintfuint8_t(rtl8019Read(GPI));
	rprintfCRLF();
	...
	rprintfProgStrM(" ");
	rprintfuint8_t(rtl8019Read(CPR));
