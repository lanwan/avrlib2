...
{
	rprintfuint8_t(ethaddr->addr[0]);
	rprintfChar(':');
	rprintfuint8_t(ethaddr->addr[1]);
	rprintfChar(':');
	rprintfuint8_t(ethaddr->addr[2]);
	rprintfChar(':');
	rprintfuint8_t(ethaddr->addr[3]);
	rprintfChar(':');
	rprintfuint8_t(ethaddr->addr[4]);
	rprintfChar(':');
	rprintfuint8_t(ethaddr->addr[5]);
}
